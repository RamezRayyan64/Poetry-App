...
import com.example.rayyantech.poetry_app_ui.activities.LikesPoemProfileActivity;
...
public class FragmentLikesPoemItemAdapter extends RecyclerView.Adapter {
    ...
    public FragmentLikesPoemItemAdapter(List<UsersInfoModel> usersInfoModelList, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder.getClass() == ViewHolderLeft.class) {
            ...
            ((ViewHolderLeft) holder).itemView.setOnClickListener(v -> {
                context.startActivity(new Intent(context, LikesPoemProfileActivity.class)
                        .putExtras(bundle));
            });
